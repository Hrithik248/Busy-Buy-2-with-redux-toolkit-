...
export default function SignIn() {
    ...
    return (
        <form className={style.formCon} onSubmit={(e) => { e.preventDefault(); handleSignIn(email, password) }}>
            ...
            <input className={style.password} type="password" placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} />
