...
export default function IncDecBtn(props) {
    ...
    return (
        <div className={style.btnCon}>
            ...
            <img src='https://cdn-icons-png.flaticon.com/128/56/56889.png' alt="Decrement" onClick={() => dispatch(handleRemoveFromCart({id:product.id}))} />

            {/* Displaying the current quantity */}
            {qty}

            {/* Increment button with an icon, invoking handleAddToCart on click */}
            <img src='https://cdn-icons-png.flaticon.com/128/1237/1237946.png' alt="Increment" onClick={() => dispatch(handleAddToCart({id:product.id}))} />
        </div>
    );
}
